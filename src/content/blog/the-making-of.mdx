...
import FootnoteAnchor from "../../components/FootnoteAnchor.tsx";
import FootnoteLink from "../../components/FootnoteLink.tsx";
...
<div>
<FootnoteAnchor number={2} /> <span class="ml-2 text-gray-900 bg-black hover:bg-gray-300 hover:text-red-800 p-0.5 -m-0.5">The devil,
